          ...
          <div className="space-y-6 animate-fade-up" style={{ animationDelay: '0.2s' }}>
            ...
            <div className="glass rounded-2xl p-6">
              ...
              <ul className="space-y-3">
                {[
                  language === 'ar' ? 'إشعار فوري عند الإطلاق' : 'Instant notification at launch',
                  language === 'ar' ? 'وصول مبكر إلى المنصة' : 'Early access to the platform',
                  language === 'ar' ? 'عروض حصرية للأعضاء الأوائل' : 'Exclusive offers for early members',
                  language === 'ar' ? 'تحديثات منتظمة حول التقدم' : 'Regular updates on progress',
                ].map((item, index) => (
